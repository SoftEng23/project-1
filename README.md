...
The dynamic web app I demoed to Revature is in the project-1-main folder. Most of the files are jsp and HTML with some javascript and bootstrap styling(CSS).
