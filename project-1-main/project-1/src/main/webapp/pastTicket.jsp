	...
	<div class="div">
		<div class="font">
			<div align="center">
				...
				<sql:query dataSource="${conn}" var="rs">select * from employee where eid='${param.eid}'</sql:query>

				<c:forEach var="user" items="${rs.rows}">
					<c:out
						value="Username: ${user.username} your ${user.type} ticket is ${user.status}!!! "></c:out>
