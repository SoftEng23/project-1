...
<body style="background-color: #00b7ff;">
	<div class="div">
		<div class="font">
			<form action="reimbRequest.jsp" method="post">
				<table align="center">
					<tbody>
						<tr>
						...
						<tr>
							<td>Eid :</td>
							<td><input type="number" id="eid" required="required">
							</td>
						</tr>
						<tr>
							<td><input
			...
			<div align="center">
				...
				<sql:query dataSource="${conn}" var="rs">select * from manager where username='${param.username}' and password='${param.pwd}';</sql:query>

				<c:forEach var="user" items="${rs.rows}">
					<c:out
						value="Hello ${user.username}, Your Login was Successfull!!!"></c:out>
