	...
	<div class="div">
		<div class="font">
			<div>
				...
				<sql:query dataSource="${conn}" var="rs">select * from employee where password='${param.pwd}'</sql:query>

				<c:forEach var="user" items="${rs.rows}">
					<c:out
						value="Username: ${user.username} your ticket is pending review!!! "></c:out>
