	...
	<div class="div">
		<div class="font">
			<div align="center">
					...
					<table>
						<tbody>
							...
							<tr>
								...
								<td><input type="text" name="status" required="required">
								</td>
							</tr>
							<tr>
								<td>Manager Note:</td>
							...
							<tr>
								<td><input
									...
									type="submit" value="Update Status"></td>
							</tr>
				...
				<sql:query dataSource="${conn}" var="rs">select * from employee where username='${param.username}'</sql:query>

				<c:forEach var="user" items="${rs.rows}">
					<c:out
						value="Username: ${user.username} Eid: ${user.eid} has ticket(s): ${user.type} ${user.amount} ${user.status}"></c:out>
					<br>
